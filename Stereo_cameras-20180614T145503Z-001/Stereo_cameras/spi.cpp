...
//VoSPI
unsigned char spi_mode = SPI_MODE_3; // (CPOL = 1 , CPHA = 1); SCK(high when idle)
unsigned char spi_bitsPerWord = 8;
unsigned int spi_speed = 16000000; // max clock rate 20MHz
